...
def betterEvaluationFunction(currentGameState):
    ...
    for food in newFood.asList():
      remainFoods += 1
      tmpDis = manhattanDistance(PacPos,food)
      if tmpDis < nearestFoodDistance:
        nearestFoodDistance = tmpDis
    ...
    #evalue = scoreEvaluationFunction(currentGameState) i
    evalue = scoreEvaluationFunction(currentGameState)-2*nearestFoodDistance - 100*remainFoods
